...
export default function Dropdown() {
  ...
  return (
    <div className="relative flex items-center" ref={dropdownRef}>
      ...
      <div
        className={`absolute right-0 w-44 bg-white border rounded shadow-lg z-10 transition-all duration-300 ease-in-out overflow-hidden ${
        ...
        {userSession ? (
          <div>
            ...
            >
              ...
              <Image
                src={"/assets/icon/personblack.png"}
                width={23}
                height={23}
                alt=""
              />
          ...
          <>
            <Link
              className="flex justify-between w-full text-left px-2 py-2 hover:bg-gray-100"
              href={"/login"}
            >
