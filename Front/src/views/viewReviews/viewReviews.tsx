...
useEffect(() => {
    ...
    return (
        <div className="w-4/5 m-auto mt-10 md:mt-0">
            <h2 className="text-3xl font-bold text-center text-neutral-800 mb-6">Reviews</h2>
            <div className="w-11/12 md:w-1/2 m-auto mb-4 flex items-center border rounded-xl bg-white">
                <Image
